    ...
    render() {
        return (
            <div class="container-fluid">
                <div class="row">
                    <div class="col-2">
                        {this.state.menu.map((e, f) => <Menu value={e} key={"menu" + f} />)}
                    </div>
                    <div class="col-7">
                        <h1>Inicio</h1>
                        {this.state.tweets.map((e, f) => <Tweet value={e} key={"tweet" + f} />)}
                    </div>
                    <div class="col-3">
                        <input class="form-control" type="text" placeholder="Busca algo en twitter"/>
                        <br></br>
                        <div class="card">
                            <div class="card-body">
                                {this.state.trends.map((e,f) => <Trend value={e} key={"trend"+f} />)}
                            </div>
                        </div>
                        <br></br>
                        <div class="card">
                            ...
                            <div class="card-body">
                                {this.state.tofollow.map((e,f) => <Follow value={e} key={"fol"+f} />)}
                            </div>
                        </div>
                        <p>Terminos y condiciones reservados. @Twitter2 2019</p>
                    </div>
                    </div>
                </div>
                );
